...
function attachTodoFormListener() {
    function processTodoFormData(event) {
        ...
        const todoProject = document.querySelector('#todo-project-title').value;
        ...
        new createTodo(todoProject, todoTitle, todoDescription, todoDueDate, todoNotes, todoPriority);
        displayAllTodos();
    }  
